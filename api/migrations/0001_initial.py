    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2020, 7, 20, 17, 18, 38, 529462, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portfolio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pending_order', to='api.Portfolio')),
                ('stock', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pending_order', to='api.Stock')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pending_order', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_date', models.DateField(default=None)),
                ('created_at', models.DateTimeField(default=datetime.datetime(2020, 7, 20, 17, 18, 38, 533007, tzinfo=utc))),
                ('submited_at', models.DateTimeField(default=None, null=True)),
                ...
                ('sma_position', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sell_order', to='api.SMAPosition')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2020, 7, 20, 17, 18, 38, 533649, tzinfo=utc))),
                ('submited_at', models.DateTimeField(default=None, null=True)),
                ('executed_at', models.DateTimeField(default=None, null=True)),
                ('portfolio', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='buy_order', to='api.Portfolio')),
